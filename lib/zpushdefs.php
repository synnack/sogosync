...
define("SYNC_MEETRESPSTATUS_SERVERERROR", 3);
define("SYNC_MEETRESPSTATUS_SERVERERROR2", 4); //the description is the same for both errors
...
define("SYNC_COMMONSTATUS_INVALIPOLICYKEY", 144);
