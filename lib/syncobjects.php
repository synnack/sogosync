    ...
    function SyncProvisioning() {
        ...
        if(Request::getProtocolVersion() >= 12.1) {
            $mapping += array (
                    ...
                    SYNC_PROVISION_UNAPPROVEDINROMAPPLIST => array (self::STREAMER_VAR => "unapprovedinromapplist", self::STREAMER_ARRAY => SYNC_PROVISION_APPNAME),  //TODO check
                    SYNC_PROVISION_APPROVEDAPPLIST => array (self::STREAMER_VAR => "approvedapplist", self::STREAMER_ARRAY => SYNC_PROVISION_HASH), //TODO check
            );
        }
